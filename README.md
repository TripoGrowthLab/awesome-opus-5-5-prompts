...
| :--- | ---: |
| [Games](docs/catalog.en.md#category-games) | 2 |
| [Scenes](docs/catalog.en.md#category-3d-scenes) | 3 |
| [Interactive](docs/catalog.en.md#category-interactive-3d) | 2 |
| [Animation](docs/catalog.en.md#category-animation-simulation) | 4 |

### Browse by model

| Browse by model | Examples |
| :--- | ---: |
| [Claude Opus 5.5](docs/catalog.en.md#model-claude-opus-5-5) | 11 |
...
[Complete catalog (11) →](docs/catalog.en.md)
