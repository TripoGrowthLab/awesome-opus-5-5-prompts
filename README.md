...
[![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) [![Stars](https://img.shields.io/github/stars/TripoGrowthLab/awesome-opus-5-5-prompts?style=flat-square&color=d58b70)](https://github.com/TripoGrowthLab/awesome-opus-5-5-prompts/stargazers) [![Tooling: MIT](https://img.shields.io/badge/Tooling-MIT-64748b?style=flat-square)](LICENSE) [![Sync prompts](https://github.com/TripoGrowthLab/awesome-opus-5-5-prompts/actions/workflows/sync-prompts.yml/badge.svg?branch=main)](https://github.com/TripoGrowthLab/awesome-opus-5-5-prompts/actions/workflows/sync-prompts.yml) [![Contributions welcome](https://img.shields.io/badge/PRs-welcome-238636?style=flat-square)](CONTRIBUTING.md)
...
<a href="https://www.tripo3d.ai/3d-prompts/models/claude-opus-5-5?utm_source=github&amp;utm_medium=referral&amp;utm_campaign=awesome_opus_5_5_prompts&amp;utm_content=readme_hero"><img src="assets/hero.webp" width="100%" alt="Awesome Opus 5.5 Prompts"></a>

**Turn an idea into a world you can play with.**

Claude Opus 5.5 prompts from real projects: Three.js scenes, browser games, animation and simulations. See the result, read the source, then adapt the prompt. Every example keeps its creator credit.

**26 examples · 1 model · 14 languages · 1 with source code**
...
| :--- | ---: |
| [Games](docs/catalog.en.md#category-games) | 5 |
| [Scenes](docs/catalog.en.md#category-3d-scenes) | 5 |
| [Assets](docs/catalog.en.md#category-3d-assets) | 2 |
| [Interactive](docs/catalog.en.md#category-interactive-3d) | 3 |
| [Animation](docs/catalog.en.md#category-animation-simulation) | 11 |
...
[Complete catalog (26) →](docs/catalog.en.md)
...
Once the interaction works, replace placeholder shapes with your own designs. [Create a 3D asset from text or an image](https://studio.tripo3d.ai/workspace/generate?utm_source=github&utm_medium=referral&utm_campaign=awesome_opus_5_5_prompts&utm_content=readme_assets), inspect the result, choose a download option, and bring it into your game or scene.

## Share something worth building

[Suggest an example](https://github.com/TripoGrowthLab/awesome-opus-5-5-prompts/issues/new?template=suggest-example.yml) with its creator, original source, reusable prompt and preview. Content and translations are curated in CMS and synchronized here automatically. See [contributing](CONTRIBUTING.md) and [maintenance](docs/maintaining.md).
